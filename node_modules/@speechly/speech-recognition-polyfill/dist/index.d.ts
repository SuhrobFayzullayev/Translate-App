 ...
 * @public
 */
export declare const createSpeechlySpeechRecognition: (appId: string) => SpeechRecognitionClass;

/**
 * Error emitted when the user does not give permission to use the microphone
 * @public
 */
export declare const MicrophoneNotAllowedError: SpeechRecognitionErrorEvent_2;
 ...
 * @public
 */
export declare type SpeechErrorCallback = (speechRecognitionErrorEvent: SpeechRecognitionErrorEvent_2) => void;
 ...
 * @public
 */
declare interface SpeechRecognition_2 {
    /**
 ...
 * @public
 */
export declare interface SpeechRecognitionClass {
    /**
 ...
 * @public
 */
declare interface SpeechRecognitionErrorEvent_2 {
    /**
 ...
 * @public
 */
declare interface SpeechRecognitionEvent_2 {
    /**
 ...
 * @public
 */
export declare type SpeechRecognitionEventCallback = (speechRecognitionEvent: SpeechRecognitionEvent_2) => void;

/**
 * Generic error when speech recognition fails due to an unknown cause
 * @public
 */
export declare const SpeechRecognitionFailedError: SpeechRecognitionErrorEvent_2;

/**
 * Object containing a transcript for the ongoing utterance and an indicator of whether that transcript is final or not
 * @public
 */
declare interface SpeechRecognitionResult_2 {
    /**
